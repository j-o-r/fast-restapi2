...
const isFileName = (s) => {
  ...
  // Start with a normal char a-zA-Z0-9
  // end with an extension (3,4 alpha-nummeric)
  // const valid = /^[a-zA-Z0-9]{1}[\w-,\s-.(){}]+\.[A-Za-z0-9]{1,4}$/;
  // const valid = /^[a-zA-Z0-9]{1}[\x21-\x7E\s]+\.[A-Za-z0-9]{1,4}$/;
  // // const validFileName = /^[a-zA-Z 0-9_.-]{4,}$/;
  // return valid.test(s);
  return true;
};
/**
